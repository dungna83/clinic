 ...
 *   $doctors = $osloginService->doctors;
 *  </code>
 */
class Google_Service_CloudOSLogin_Resource_Users extends Google_Service_Resource
{
   ...
   * Google Compute Engine. (doctors.getLoginProfile)
   *
   * @param string $name The unique ID for the user in format `doctors/{user}`.
   ...
   * login profile. (doctors.importSshPublicKey)
   *
   * @param string $parent The unique ID for the user in format `doctors/{user}`.
