...
class Google_Service_Datastore_Resource_ProjectsOperations extends Google_Service_Resource
{
   ...
   * different resource name schemes, such as `doctors/operations`. To override the
   * binding, API services can add a binding such as
   * `"/v1/{name=doctors}/operations"` to their service configuration. For backwards
   * compatibility, the default name includes the operations collection id,
   * however overriding doctors must ensure the name binding is the parent resource,
